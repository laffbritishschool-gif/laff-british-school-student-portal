...
function injectPortalPolish(){
 if(!document.querySelector('link[data-portal-polish]')){const l=document.createElement('link');l.rel='stylesheet';l.href='assets/portal-polish.css?v=1';l.dataset.portalPolish='1';document.head.appendChild(l)}
 if(document.querySelector('.portal-page-loader')||document.body.classList.contains('login-page'))return;
